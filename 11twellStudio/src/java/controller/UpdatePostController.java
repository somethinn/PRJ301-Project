...
public class UpdatePostController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("edit-post-management.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.setCharacterEncoding("UTF-8");
        String postTitle = request.getParameter("post-tittle");
        String postImage = request.getParameter("post-image");
        String postContent = request.getParameter("post-content");
        String postStatus_raw = request.getParameter("post-status");
        String postID_raw = request.getParameter("post-id");
        ...
        try {
            postID = Integer.parseInt(postID_raw);
            postStatus = Integer.parseInt(postStatus_raw);
            PostDAO postDAO = new PostDAO();
