...
<html>
    ...
    <body>
        ...
        <div class="account">
            ...
            <h1>Date of birth</h1>
            <c:if  test="${sessionScope.msgSetDate != null}">
            ...
            <c:if test="${sessionScope.account.userGender == 'F'}">
                ...
                <input id="female" name="userGender" type="radio" value="F" style="width: 10%; display: inline-block; height: 16px" checked><label  for="female"  style="margin: 16px; font-size: 16px;font-weight: 500">Female</label>
            </c:if>
            <c:if test="${sessionScope.account.userGender == 'M'}">
                <input id="male" name="userGender" type="radio" value="M" style="width: 10%; display: inline-block; height: 16px"  checked><label  for="male" style="margin: 16px; font-size: 16px;font-weight: 500">Male</label>
...
>>>>>>> ad58467d366c3d256d7056d0290fe52563cd9e32-->
