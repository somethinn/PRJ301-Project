...
<html>
    <head>
        ...
        <title>ADD</title>
        <link rel="icon" type="image/png" href="assets/img/favicon_io/favicon-32x32.png">        <link rel="stylesheet" href="./assets/css/styles.css">
    ...
    <body>
        <div class="add_movie">
            <div class="add_movie--section">
                ...
                <form action="add-post" class="add_movie--section--form" method="POST">
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                            <p>Post Tittle:</p>
                        </div>
                        <input type="text" placeholder="Post Tittle" name="post-tittle" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                            <p>Post Image:</p>
                    ...
                    <input type="text" placeholder="Post Content" name="post-content" required="">
                    </div>
