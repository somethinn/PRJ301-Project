    ...
    <body>
        <div class="add_movie">
            <div class="add_movie--section">
                ...
                <form action="add-movie" class="add_movie--section--form" method="POST">
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Movie Tittle:</p>
                        </div>
                        <input style="margin-top: 0" type="text" placeholder="Movie Tittle" name="movie-tittle" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Genre:</p>
                    ...
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        ...
                        <input type="file" name="movie-image" required=""/>
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Premiere:</p>
                        </div>
                        <input type="date" placeholder="Movie Premiere" name="movie-premiere" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Director:</p>
                        </div>
                        <input type="text" placeholder="Movie Director" name="movie-director" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Movie Time:</p>
                        </div>
                        <input type="number" placeholder="Movie Time" name="movie-time" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Movie Slide:</p>
                        </div>
                        <input type="file" name="movie-slide" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Movie Description:</p>
                        </div>
                        <input type="text" placeholder="Movie Description" name="movie-des" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Movie Trailer Link:</p>
                        </div>
                        <input type="text" placeholder="Movie Trailer Link" name="movie-trailer" required="">
                    </div>
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                        <div style="min-width: 160px">
                        <p>Movie Status:</p>
