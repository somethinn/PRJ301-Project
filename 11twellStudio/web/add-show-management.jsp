    ...
    <body>
        <div class="add_movie">
            <div class="add_movie--section">
                ...
                <form action="add-show" class="add_movie--section--form" method="POST">
                    <div class="add_movie--section--form--item" style="width: 100%; display: flex; justify-content: center; align-items: center;">
                    <div style="min-width: 160px">
                        <p>Show Tittle:</p>
                    </div>
                    <select name="show-movie" id="">                       
                        <c:forEach var="m" items="${requestScope.listMovie}">
                    ...
                    <input type="date" placeholder="Show Date" name="show-date" value="${param.show-date}" required="">
                    ...
                    <select name="show-slot" id="">                       
                        <c:forEach var="sl" items="${requestScope.listSlot}">
                            <option value="${sl.slotID}">${sl.slotTime}</option>                                                   
                        </c:forEach>
                    </select> 
                    </div>
                    ...
                    <input type="number" placeholder="Show Price" name="show-price" required="">
                    </div>
